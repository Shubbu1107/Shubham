<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory.Master" AutoEventWireup="true" CodeBehind="ItemName.aspx.cs" Inherits="MasterPage19.WebForm15" %>
...
<table cellspacing="4" class="auto-style17"> 
    <tr>
        <td class="auto-style18" style="font-size: 25px; font-weight: 300; text-align: center; background-color: #C0C0C0;">Item Name</td>
    </tr>
    <tr>
        <td>
            <table cellspacing="4" class="auto-style17">
                ...
                <tr>
                    ...
                    <td class="auto-style27">
                        <asp:SqlDataSource ID="SDSitemtype" runat="server" ConnectionString="<%$ ConnectionStrings:WinServer %>" SelectCommand="SELECT * FROM [itemname]">
                        </asp:SqlDataSource>
