<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Inventrylogin.aspx.cs" Inherits="MasterPage19.Inventrylogin" %>
                        ...
                        <div class="container rounderdcorrner" id="adduser" role="dialog">
                           ...
                           <asp:TextBox ID="txtemail" CssClass="form-control" placeholder="Email" ToolTip="Email" runat="server" Height="20px" Width="131px" />
                                    ...
                                    <div class="modal-footer">
                                        <asp:Button ID="btncencel" CssClass="rounderdcorrner" Text="Cencel" runat="server" PostBackUrl="~/Inventrylogin.aspx" />
                                        &nbsp;&nbsp;&nbsp;
